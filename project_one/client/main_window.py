...
sys.path.append('../')
from project_one.client.main_window_conv import Ui_MainClientWindow
from project_one.client.add_contact import AddContactDialog
from project_one.client.del_contact import DelContactDialog
from project_one.client.client_database import ClientDatabase
from project_one.client.transport import ClientTransport
from project_one.client.start_dialog import UserNameDialog
from project_one.common.errors_user import ServerError
